...
while($row = mysql_fetch_array($result)){   //Creates a loop to loop through results
	echo "<tr><td>" . $row['filename'] . "</td><td>" . $row['size']. "</td><td>" ."<a href='../files/".$row['short_id']."/".$row['short_id'].".zip"."'>Download</a>" . "</td><td>" ."</td></tr>";  //$row['index'] the index here is a field name
}
